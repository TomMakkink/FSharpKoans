...
module ``04: Tuples`` = 
    ...
    let ``06 Using the wildcard pattern`` () = 
        ...
        let name, _, _, weapon_name = "Shinji", 9103, true, "Unit 01" // The wildcard patterns will match to name and weapon type but will not bind to them and so pass the test.
